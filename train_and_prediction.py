...
db = pymysql.connect(
    ...
    user="sql12791888",                # your freesqldatabase username
    password="gKCQabmHx8",    # your freesqldatabase password
    database="sql12791888",            # your freesqldatabase database name (usually same as username)
